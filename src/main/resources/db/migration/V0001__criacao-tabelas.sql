...
alter table ticket add constraint fk_ticket_categoria 
foreign key (categoria_id) references categoria (id);

alter table ticket add constraint fk_ticket_prioridade 
foreign key (prioridade_id) references prioridade (id);

alter table ticket add constraint fk_ticket_status 
